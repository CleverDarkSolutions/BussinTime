  ...
  return(
    <div>
      ...
      <aside id="default-sidebar"
        className="fixed left-0 top-20 z-40 h-screen w-[15%] -translate-x-full transition-transform sm:translate-x-0"
        aria-label="Sidebar">
